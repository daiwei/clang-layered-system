...
typedef struct {
    ...
    gps_status_callback status_cb;              //once
    gps_sv_status_callback sv_status_cb;
    gps_nmea_callback nmea_cb;                  //useless
    gps_set_capabilities set_capabilities_cb;   //useless
    gps_acquire_wakelock acquire_wakelock_cb;   //useless
    gps_release_wakelock release_wakelock_cb;   //useless
    gps_create_thread create_thread_cb;         //once
    gps_request_utc_time request_utc_time_cb;   //useless
} GpsCallbacks;
